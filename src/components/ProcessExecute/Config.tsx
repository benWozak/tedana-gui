...
import { Table, Input, Select, Toggle, CodeSnippet, Section } from "../ui";
...
function Config({
  ...
  return (
    <div className="w-full container mx-auto">
      ...
      <Section title="Function Configs">
        <div className="mb-4">
      ...
      */}
      <div className="mt-4">
        <h2 className="text-xl font-bold">Generated Command</h2>
        <CodeSnippet
          language="bash"
          code={
            <>
              tedana <CommandDisplay config={config} />
            </>
          }
        />
      </div>
